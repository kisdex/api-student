...
class Jwt{
    ...
    private $authHash; //权限hash
    private $authList; //权限列表
	private $secrect;
	private $expTime;
    ...
    public function setAuthList($list){
        $this->authList = $list;
        return $this;
    }
	...
	public function encode(){
		...
		$this->token = (new Builder())->setHeader('alg','HS256')
			...
			->set('uid',$this->uid)
//            ->set('authList',$this->authList)
//            ->set('authHash',$this->authHash)
...
//            $this->authHash = $this->decodeToken->getClaim('authHash');
//            $this->authList = $this->decodeToken->getClaim('authList');
